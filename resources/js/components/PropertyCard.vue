<template>
	<div class="bg-gray-300  overflow-hidden rounded  items-center rounded-lg bg-white overflow-hidden md:object-cover md:object-center">
		<img class="w-full object-cover object-center" :src="property.imageUrl" :alt="property.imageAlt"/>
		<div class="p-6">
			<div class="text-gray-600 text-xs uppercase font-semibold tracking-wide">
				{{ property.beds }} beds &bull; {{ property.baths }} baths
			</div>
				<h3 class="font-semibold text-lg leading-tight truncate">{{ property.title }}</h3>
			<div class="mt-1">
